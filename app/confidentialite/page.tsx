            ...
            <>
              ...
              <ul>
                ...
                <li>
                  ...
                  {pick(
                    locale,
                    " : accéder uniquement aux fichiers que Biltia a créés ou que vous avez explicitement ouverts avec Biltia. Le reste de votre Drive nous est invisible.",
                    ": access only the files Biltia created or that you explicitly opened with Biltia. The rest of your Drive is invisible to us.",
                  )}
                </li>
              </ul>
              <p>
